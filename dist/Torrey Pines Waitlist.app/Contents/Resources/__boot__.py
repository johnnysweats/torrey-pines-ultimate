...
_recipes_pil_prescript(['MpegImagePlugin', 'ImtImagePlugin', 'BlpImagePlugin', 'AvifImagePlugin', 'EpsImagePlugin', 'TgaImagePlugin', 'IcnsImagePlugin', 'FpxImagePlugin', 'SgiImagePlugin', 'PixarImagePlugin', 'PdfImagePlugin', 'FitsImagePlugin', 'XVThumbImagePlugin', 'ImImagePlugin', 'TiffImagePlugin', 'FliImagePlugin', 'GifImagePlugin', 'CurImagePlugin', 'Jpeg2KImagePlugin', 'WebPImagePlugin', 'GbrImagePlugin', 'DdsImagePlugin', 'FtexImagePlugin', 'McIdasImagePlugin', 'PalmImagePlugin', 'PpmImagePlugin', 'MspImagePlugin', 'QoiImagePlugin', 'PcdImagePlugin', 'SpiderImagePlugin', 'PngImagePlugin', 'PcxImagePlugin', 'MicImagePlugin', 'GribStubImagePlugin', 'BmpImagePlugin', 'IptcImagePlugin', 'XbmImagePlugin', 'WmfImagePlugin', 'XpmImagePlugin', 'BufrStubImagePlugin', 'SunImagePlugin', 'IcoImagePlugin', 'PsdImagePlugin', 'JpegImagePlugin', 'Hdf5StubImagePlugin', 'DcxImagePlugin', 'MpoImagePlugin'])
...
DEFAULT_SCRIPT='golf_waitlist_app_fresh.py'
SCRIPT_MAP={}
_run()
